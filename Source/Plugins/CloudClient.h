...
public:
    ...
    virtual void OnGet( CloudQueryResult* result, bool* deallocateRowsAfterReturn )
    {
        (void)result;
    ...
    virtual void OnSubscriptionNotification( CloudQueryRow* result, bool wasUpdated, bool* deallocateRowAfterReturn )
    {
        (void)result;
        (void)wasUpdated;
